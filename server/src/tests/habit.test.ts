...
//TODO
// Should not create habit with invalid description/completed
// Should not update habit with invalid description/completed
// Should delete user habit
// Should not delete habit if unauthenticated
// Should not update other users habit
...
// Should fetch only completed habits
// Should fetch only incomplete habits
